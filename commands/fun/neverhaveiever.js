...
module.exports.run = async(client, message, args) => {
    ...
    message.channel.send(new client.embed().setDescription(`${nhie.slice(13, nhie.length)}`).setTitle(`Never Have I Ever...`).setFooter(`${message.guild.name} | Made By Fuel#2649`, message.guild.iconURL({ dynamic: true })))
}