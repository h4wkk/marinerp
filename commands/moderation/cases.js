...
module.exports.run = async(client, message, args) => {
    ...
    if (!punishments.length) return message.channel.send(new client.embed().setDescription('There arent any cases on the server!').setFooter(`${message.guild.name} | Made By Fuel#2649`, message.guild.iconURL({ dynamic: true })))
