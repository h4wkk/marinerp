...
module.exports.run = async(client, message, args) => {
    ...
    message.channel.send(new client.embed().setDescription('This channel will be deleted in 10 seconds.').setFooter(`${message.guild.name} | Made By Fuel#2649`, message.guild.iconURL({ dynamic: true })))
