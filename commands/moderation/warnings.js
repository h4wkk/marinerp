...
module.exports.run = async(client, message, args) => {
    ...
    if (!member) return message.channel.send(new client.embed().setDescription(`Please specify a user to view warnings on.`).setFooter(`${message.guild.name} | Made By Fuel#2649`, message.guild.iconURL({ dynamic: true })))
