...
module.exports.run = async(client, message, args) => {
    ...
    if (!command) return message.channel.send(new client.embed().setDescription(`Please provide me a command to reload.`).setFooter(`${message.guild.name} | Made By Fuel#2649`, message.guild.iconURL({ dynamic: true })))
